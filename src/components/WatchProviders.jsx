...
import { getProviderLogo } from '../utils/imageUtils'; // Assuming you have this

const COUNTRIES = [  // Consider moving to a separate constants file
...
const WatchProviders = ({ itemId, mediaType }) => {
    ...
    useEffect(() => {
        const fetchProviders = async () => {
            ...
            try {
                ...
                console.error('Error fetching watch providers:', error);
                 setWatchProviders({}); // Avoid null/undefined errors
            } finally {
                 setIsLoading(false);
            }
        };
        ...
        fetchProviders();
    }, [itemId, selectedCountry, mediaType]); // Include mediaType in dependencies
   ...
   const handleCountryChange = (event) => {
    ...
    if (!watchProviders || !watchProviders[selectedCountry]) {
       return (
         <section className="glass-container p-8">
                ...
                <p>No watch providers available for {selectedCountry}.</p>
           </section>
       );
      }
    ...
    return (
        <section className="glass-container p-8">
            ...
            {/* Check for any providers at all */}
            {(!providers.flatrate &&
              !providers.rent &&
              !providers.buy) && (
