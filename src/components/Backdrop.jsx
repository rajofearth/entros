...
const Backdrop = ({ item, navigate, mediaType }) => {
    ...
    // Get end year, handling ongoing series
    ...
    const runtime = item.runtime
     ...
     // Calculate average rating and total votes (for Collection)
    let totalRating = 0;
    let totalVotes = 0;
            ...
            >
             ...
             <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Collection-Specific Info (below title) */}
                    ...
                    {/* Movie/TV Show Info (below title) */}
                    {mediaType !== 'collection' && (
